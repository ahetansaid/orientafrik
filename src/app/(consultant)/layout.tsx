      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-6">
            <Link href="/consultant/tableau-de-bord" className="text-lg font-bold text-navy">
              {MARQUE}
            </Link>
            <nav className="flex gap-4 text-sm text-slate-600">
              <Link href="/consultant/tableau-de-bord" className="hover:text-navy">
                Tableau de bord
              </Link>
              <Link href="/consultant/disponibilites" className="hover:text-navy">
                Disponibilités
              </Link>
              <Link href="/consultant/consultations" className="hover:text-navy">
                Consultations
              </Link>
            </nav>
          </div>
